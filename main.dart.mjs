...
_1807: () => Date.now(),
_1814: () => new XMLHttpRequest(),
_1815: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1816: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1818: x0 => x0.getAllResponseHeaders(),
...
_1847: (x0,x1) => x0.test(x1),
_1848: (x0,x1) => x0.exec(x1),
_1849: (x0,x1) => x0.exec(x1),
_1850: x0 => x0.pop(),
_1854: (x0,x1,x2) => x0[x1] = x2,
_1856: o => o === undefined,
_1857: o => typeof o === 'boolean',
_1858: o => typeof o === 'number',
_1860: o => typeof o === 'string',
_1863: o => o instanceof Int8Array,
_1864: o => o instanceof Uint8Array,
_1865: o => o instanceof Uint8ClampedArray,
_1866: o => o instanceof Int16Array,
_1867: o => o instanceof Uint16Array,
_1868: o => o instanceof Int32Array,
_1869: o => o instanceof Uint32Array,
_1870: o => o instanceof Float32Array,
_1871: o => o instanceof Float64Array,
_1872: o => o instanceof ArrayBuffer,
_1873: o => o instanceof DataView,
...
_1899: l => arrayFromDartList(Array, l),
_1900:       (s, length) => {
        if (length == 0) return '';
...
_1909: (o, p) => o[p],
_1910: (o, p, v) => o[p] = v,
_1911: (o, m, a) => o[m].apply(o, a),
_1913: o => String(o),
_1914: (p, s, f) => p.then(s, f),
_1915: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_1922: (x0,x1) => x0[x1],
_1925: x0 => x0.flags,
_1926: x0 => x0.multiline,
_1927: x0 => x0.ignoreCase,
_1928: x0 => x0.unicode,
_1929: x0 => x0.dotAll,
_1930: (x0,x1) => x0.lastIndex = x1,
_1932: (o, p) => o[p],
_1998: () => globalThis.XMLHttpRequest.UNSENT,
_2002: () => globalThis.XMLHttpRequest.DONE,
_2012: x0 => x0.readyState,
_2014: (x0,x1) => x0.timeout = x1,
_2016: (x0,x1) => x0.withCredentials = x1,
_2017: x0 => x0.upload,
_2018: x0 => x0.responseURL,
_2019: x0 => x0.status,
_2020: x0 => x0.statusText,
_2022: (x0,x1) => x0.responseType = x1,
_2023: x0 => x0.response,
_2037: x0 => x0.loaded,
_2038: x0 => x0.total,
